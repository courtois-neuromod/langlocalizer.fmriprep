...
#SBATCH --output=/lustre10/scratch/bpinsard/cneuromod.langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-02_ses-002.out
#SBATCH --error=/lustre10/scratch/bpinsard/cneuromod.langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-02_ses-002.err
...
flock --verbose /project/rrg-pbellec/ria-rorqual/alias/cneuromod.langlocalizer.fmriprep/.datalad_lock datalad push -d ./ --to origin
if [ -d sourcedata/freesurfer ] ; then
    flock --verbose /project/rrg-pbellec/ria-rorqual/alias/cneuromod.langlocalizer.fmriprep/.datalad_lock datalad push -J 4 -d sourcedata/freesurfer --to origin
fi 
