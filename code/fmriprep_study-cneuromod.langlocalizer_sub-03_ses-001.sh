...
#SBATCH --output=/lustre10/scratch/bpinsard/cneuromod.langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-03_ses-001.out
#SBATCH --error=/lustre10/scratch/bpinsard/cneuromod.langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-03_ses-001.err
