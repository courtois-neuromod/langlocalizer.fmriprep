...
#SBATCH --job-name=fmriprep_study-cneuromod.langlocalizer_sub-01_ses-001.job
#SBATCH --output=/lustre04/scratch/bpinsard/langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-01_ses-001.out
#SBATCH --error=/lustre04/scratch/bpinsard/langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-01_ses-001.err
...
if [ -e $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json ] ; then cp $LOCAL_DATASET/workdir/fmriprep_wf/resource_monitor.json /scratch/bpinsard/fmriprep_study-cneuromod.langlocalizer_sub-01_ses-001_resource_monitor.json ; fi 
if [ $fmriprep_exitcode -ne 0 ] ; then cp -R $LOCAL_DATASET /scratch/bpinsard/fmriprep_study-cneuromod.langlocalizer_sub-01_ses-001 ; fi 
