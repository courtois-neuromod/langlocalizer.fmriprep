...
#SBATCH --output=/lustre10/scratch/bpinsard/cneuromod.langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-01_ses-002.out
#SBATCH --error=/lustre10/scratch/bpinsard/cneuromod.langlocalizer.fmriprep/code/fmriprep_study-cneuromod.langlocalizer_sub-01_ses-002.err
